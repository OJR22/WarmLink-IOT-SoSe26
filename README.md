...
| Milchglas / Plexiglas-Streifen | 2 (1 pro Endpunkt) | als Lichtdiffusor hinter dem LED-Fenster im Deckel, passend zugeschnitten |
...
3. NodeMCU im Boden platzieren, USB-Anschluss zur seitlichen Öffnung
   ausrichten
4. Milchglas- bzw. Plexiglas-Streifen passend zugeschnitten in die
   Führungsschiene im Deckel-Fenster schieben, damit sich das
   LED-Licht gleichmäßiger verteilt
5. RGB-LED mit Heißkleber oder doppelseitigem Klebeband unter dem
   Diffusor befestigen (Kabel vorher anschließen!)
6. Taster mit der gedruckten Verlängerung durch die runde Öffnung in
